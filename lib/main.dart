...
import 'package:playerflutter/player.dart';
...
Future<void> requestPermissions() async {
  ...
  if (audioStatus.isGranted) {
    ...
    print('Audio permission permanently denied. Open app settings.');
    openAppSettings(); // Optionally guide user to settings
    return; // Stop further checks if permanently denied
  }

  // At this point, both permissions are granted.
  print('Both permissions granted. Proceed with accessing audio files.');
}
